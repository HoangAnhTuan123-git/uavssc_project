...
from uavssc_trainkit.uavssc_trainkit.models_rgb import CGFormerStyleSSC
...
def main():
    ...
    train_ds = RGBSSCNPZDataset(
        ...
        color_jitter=True,
        sample_list_path=split_files.get("train"),
    )
    val_ds = RGBSSCNPZDataset(
        ...
        image_size=image_size,
        color_jitter=False,
        sample_list_path=split_files.get("val"),
    )
