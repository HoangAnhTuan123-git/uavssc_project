...
time python preprocessing/scripts/10_export_lidar_ssc.py \
  --manifest "$MANIFEST" \
  ...
  --output data/processed/interval5/lidar_ssc_npz_test${N}
find data/processed/interval5/lidar_ssc_npz_test${N} -name "*.npz" | wc -l
