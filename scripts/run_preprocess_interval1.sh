...
CONFIG="${CONFIG:-${PROJECT_ROOT}/preprocessing/configs/interval1.yaml}"
MANIFEST="${MANIFEST:-${PROJECT_ROOT}/data/index/manifest_interval1.parquet}"
TAXONOMY="${TAXONOMY:-${PROJECT_ROOT}/data/index/taxonomy_uavssc.json}"
OUT_ROOT="${OUT_ROOT:-${PROJECT_ROOT}/data/processed/interval1}"
...
echo "[3/11] Build manifest with interval1_CAM_label paths"
